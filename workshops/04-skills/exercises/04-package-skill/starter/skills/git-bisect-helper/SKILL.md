...
- If user can't easily test (long compile, manual UI test) — suggest `git bisect skip`
- If both endpoints test the same — explain the bug is older than the `good` commit
